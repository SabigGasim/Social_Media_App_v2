...
public static class Results
{
    ...
    public static Result Fail(IEnumerable<Exception>? errors) => new Result { Success = false, Errors = errors };
    public static Result Fail(Exception error) => new Result { Success = false, Errors = new[] { error } };
    ...
    public static Result<T> Fail<T>(Exception? error) => 
        new Result<T> { Success = true, Value = default, Errors = error is null ? null : new[] { error } };
    public static Result<T> Fail<T>(IEnumerable<Exception>? errors) => 
